...
- Packages on the Bend hub, published by hash and waiting for names: `bend-net-http@0.14.0.0`, `bend-net-bytes@0.2.0.1`, `bend-net-wire@0.4.0.1`, `bend-net-url@0.4.0.1`, `bend-net-json@0.3.0.1`, `bend-net-encoding@0.2.1.1`, `bend-net-dns@0.3.1.0`, `bend-net-zlib@0.1.0.0`, `bend-net-router@0.1.1.0`. Each description links to its source folder. `http` and `dns` import their siblings by hash, so callers share their types. Elbow is no longer used. Fetch returns `Result` and headers are lists (`f73e022`). The README is `bf9e139`.
...
- [ ] **Name the packages.** Every package is published by hash; the hub names at most five a day. Run `bend link bend-net-bytes@0.2.0.1 0xdcce81c809e7aeb2e2c2fb775d28e0dc`, `bend link bend-net-wire@0.4.0.1 0xd0e5dfa14254dc2d25247f592b3afbe2`, `bend link bend-net-url@0.4.0.1 0x3f15daecd30cac66472f8e312600ba3b`, `bend link bend-net-json@0.3.0.1 0x2213bb53d5eea36896815fc5b459bb6e`, `bend link bend-net-encoding@0.2.1.1 0x58d0718042afbd57ac3a0124bfc0570f`, `bend link bend-net-router@0.1.1.0 0xe160436f9c54f3dba1bd01de3117931e`, `bend link bend-net-zlib@0.1.0.0 0x05a6d0cd384bf4ebc144f0bc1b2d2350`, `bend link bend-net-dns@0.3.1.0 0x4ae4f319f4174df6a2ae71eb32ba9642`, `bend link bend-net-http@0.14.0.0 0x6ee8b4f8d8a8f10e385dccb59e74e665`. Then switch the hash imports in `http.bend`, `dns/dns.bend`, and the root tests, and the README table, to the names.
